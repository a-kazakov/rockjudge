        ...
        "admin": {
            "alerts": {
                "about": (version, date) => ( // eslint-disable-line no-unused-vars
                    <div className="about">
                        <p><b>RockJudge {version}</b> (версия от {date}) &mdash; система для подсчета результатов соревнований по акробатическому рок-н-роллу.</p>
                        <p>Авторские права на систему RockJudge полностью принадлежат разработчику Артему Казакову. Соавтор системы Антон Амелин.</p>
                        <p>Система распространяется по лицензии Linum d.o.o (info@linum.hr). Для использования системы судейства RockJudge необходимо иметь право использования системы Linum LPS.</p>
