...
export default function translate(src, ...args) {
    ...
    const PHRASES = {
        "admin": {
            "alerts": {
                "about": (version, date) => ( // eslint-disable-line no-unused-vars
                    <div className="about">
                        <p><b>RockJudge {version}</b> (версия от {date}) &mdash; система автоматизации проведения соревнований по акробатическому рок-н-роллу.</p>
                        <p>Авторские права на систему RockJudge полностью принадлежат разработчику Артему Казакову. Соавтор системы Антон Амелин.</p>
                        <p>Исключительным правом распросранения данной программы обладает ООО &laquo;ПроСпорт&raquo;. Запрещено любое использование данной системы без письменного разрешения от ООО &laquo;ПроСпорт&raquo; (ОГРН 1177847156222).</p>
        ...
        "judging": {
            ...
            "confirms": {
                "confirm_all": "Вы действительно хотите подтвердить все оценки этого судьи?",
                "finalize_tour": "Вы действительно хотите финализировать этот тур?",
                "init_tour": "Вы действительно хотите пересоздать этот тур?",
                "load_program": "Вы действительно хотите перезагрузить программу для этого участника?",
                "reset_judge_scores": "Вы действительно хотите очистить все оценки судьи?",
                "shuffle_heats": "Вы действительно хотите перемешать заходы?",
                "stop_tour": "Вы действительно хотите остановить этот тур?",
                "reset_score": "Вы действительно хотите сбросить оценки судей?",
                "unconfirm_all": "Вы действительно хотите снять подтверждение во всех оценок этого судьи?",
            },
            "headers": {
