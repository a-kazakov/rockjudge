...
export default class EditorRow extends React.Component {
    ...
    handleNumAdvancesChange = (event) => this.props.onFieldChange("num_advances", event.target.value);
    handleParticipantsPerHeatChange = (event) => this.props.onFieldChange("participants_per_heat", event.target.value);
    handleHopeTourChange = (event) => this.props.onFieldChange("hope_tour", event.target.checked);
    handleScoringSystemNameChange = (event) => this.props.onFieldChange("scoring_system_name", event.target.value);
    handleDefaultProgramChange = (event) => this.props.onFieldChange("default_program", event.target.value);
                ...
                <div className="row">
                    <div className="col-12 wrapper">
                        ...
                        <div className="col-8">
                            ...
                            <input
                                disabled={ this.props.loading || this.props.entry?.finalized }
                    ...
                    <div className="col-12 wrapper">
                        <div className="col-24">
                            <label>
                                ...
                                >
                                    { rules_set.meta.scoring_systems.map(this.renderScoringSystemNameOption) }
                                </select>
                            </label>
                        </div>
