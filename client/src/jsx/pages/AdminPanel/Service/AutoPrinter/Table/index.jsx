...
export default class Table extends React.PureComponent {
    ...
    handleMove = (tour_id, action, direction) => {
        ...
        const next_tour_idx = this.props.tours.findIndex(tour => tour.id === tour_id) + tour_delta;
        const next_tour = this.props.tours[next_tour_idx];
        const next_action_idx = this.props.possibleActions.indexOf(action) + action_delta;
    ...
    render() {
        return (
            <table className="tours-table"><tbody>
                <tr>
