...
const OPTIONS_2 = ["left", "right"].map(x =>
    _(`tablet.tech_judge.judging_positions.${x}`),
);
const OPTIONS_3 = ["left", "central", "right"].map(x =>
    _(`tablet.tech_judge.judging_positions.${x}`),
);
...
export default class Button extends React.Component {
    ...
    renderButtonText() {
        switch (this.props.numOptions) {
            ...
            default:
                return _(
                    `tablet.tech_judge.judging_positions.custom`,
    ...
    render() {
        return (
            <button type="button" {...onTouchEndOrClick(this.handleClick)}>
