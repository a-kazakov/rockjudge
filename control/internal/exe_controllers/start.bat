...
%reg51%if defined qedit_val (echo y|reg add "%qkey%" /v "%qprop%" /t REG_DWORD /d %qedit_val% > nul 2> nul &goto :mainstart)
...
%reg51%echo y|reg add "%qkey%" /v "%qprop%" /t REG_DWORD /d 0 > nul 2> nul
