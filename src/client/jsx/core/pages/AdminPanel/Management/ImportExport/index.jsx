        ...
        return (
            <div className="ImportExport">
                ...
                <div className="body">
                    ...
                    <form className="import-form" onSubmit={this.handleFormSubmission}>
                        <label className="browse">
                            <div>{_("global.labels.browse")}</div>
                        ...
                        <br />
                        <ImportItemsSelector ref={this.makeSelectorRef} />
                        <br />
                        <button disabled={!this.canImport()} type="submit">
                            {_("admin.buttons.import")}
                        </button>
                    </form>
                    <h3>{_("admin.headers.export_competition")}</h3>
                    <button type="button" onClick={this.handleExportClick}>
