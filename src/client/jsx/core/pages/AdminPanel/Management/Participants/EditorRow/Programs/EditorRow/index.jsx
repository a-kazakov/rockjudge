...
export default class EditorRow extends React.Component {
    static propTypes = {
        ...
        formData: PT.shape({
            ...
            elements: PT.arrayOf(PT.object.isRequired).isRequired,
        }).isRequired,
    ...
    handleDefaultForChange = event =>
        this.props.onFieldChange("default_for", event.target.value);
    ...
    render() {
        return (
            <form className={this.getClassName()} onSubmit={this.handleSubmission}>
                ...
                <button className="submit-button" disabled={this.props.loading}>
