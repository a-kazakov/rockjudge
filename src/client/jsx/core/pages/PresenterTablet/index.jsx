...
export default class PresenterTablet extends React.Component {
    ...
    renderBody() {
        ...
        switch (this.state.page) {
            case "info":
                return <InfoPage competition={competition} />;
            case "heats":
                return (
                    <HeatsPage
            ...
            case "plan":
                return <PlanPage competition={competition} />;
            case "results":
                return <ResultsPage competition={competition} />;
        }
    }
    ...
    render() {
        return (
            <div className="PresenterTablet">
                <LeftBar page={this.state.page} onPageChange={this.handlePageChange} />
