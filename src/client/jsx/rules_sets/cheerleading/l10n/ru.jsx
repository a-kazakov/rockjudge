...
const JAZZ_GROUP_HINT = [
    [
        ["Тиэ", "Техника: исполнение элементов"],
...
const FREESTYLE_GROUP_HINT = [
    [
        ["Тп", "Техника: работа с помпонами"],
        ["Тт", "Техника: исполнение танцевальной техники"],
    ],
    [
        ["Тиэ", "Техника: исполнение элементов"],
        ["Гср", "Гр. исполнение: синхронность, исп-е в ритм"],
...
const HIPHOP_GROUP_HINT = [
    [
        ["Тс", "Техника: сила и амплитуда движений"],
        ["Ткп", "Техника: контроль положение тела"],
    ],
    [
        ["Тсэ", "Техника: исполнение сопртивных элементов"],
        ["Гср", "Гр. исполнение: синхронность, исп-е в ритм"],
    ],
    [
        ["Год", "Гр. исполнение: однородность движений"],
