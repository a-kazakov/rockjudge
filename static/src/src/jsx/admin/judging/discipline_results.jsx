...
import {
    DisciplineResultsTable,
    DisciplineResultsPresenterTable,
    DisciplineResultsScreenOperatorTable,
} from "./rosfarr/discipline_results";

export class DisciplineResultsButtons extends React.Component {
    signal(message) {
...
export class DisciplineResults extends React.Component {
