...
import { DisciplineResults, DisciplineResultsButtons } from "./discipline_results";

export class Judging extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    renderBody() {
        ...
        case "results-1":
            return <TourResultsBody printable verbosity="1" {...props} />
        case "results-2":
            return <TourResultsBody printable verbosity="2" {...props} />
        case "results-3":
            return <TourResultsBody printable verbosity="3" {...props} />
        case "discipline-results":
