...
import { TourAdminScoreCell } from "./rosfarr/tour_admin";
...
export class TourAdminButtons extends React.Component {
    signal(message) {
...
class TourAdminScoreCellWrapper extends React.Component {
    ...
    startEditing() {
        ...
        this.setState({
            editing: true,
            current_value: clone(this.props.value),
        });
    }
    stopEditing() {
        this.setState({
...
export class TourAdminBody extends React.Component {
