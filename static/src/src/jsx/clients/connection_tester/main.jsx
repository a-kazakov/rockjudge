...
import { TabletSelectorInput } from "ui/tablet_components";
import { clone } from "common/tools";


export class ConnectionTester extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            payload_size: 1000,
    ...
    ping() {
        ...
        let new_state = clone(this.state.active_pings);
    ...
    onPingReply(response) {
        ...
        let active_pings = clone(this.state.active_pings);
        let finished_pings = clone(this.state.finished_pings);
        finished_pings.push({
            ...
            <div className="container-fluid">
                <div className="row connection-tester">
                    ...
                    <div className="col-md-6">
                        ...
                        <h3>Statistics out of 100:</h3>
                        { this.renderStat(stat100) }
                        <h3>Statistics out of 1000:</h3>
