...
import { getScoringType } from "common/rosfarr/base";
...
class ScorePartScale extends React.Component {
    ...
    render() {
        ...
        case "point5":
            return <TabletPoint5SelectInput style="two-lines" {...this.props} />
        case "integer":
...
export class TabletScoreInput extends React.Component {
